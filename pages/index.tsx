    ...
    <div className="container" style={{ backgroundColor: '#0F0F0F' }}>
      ...
      <main>
        ...
        <section className="content-section">
          <div className="container">
            <div className="content-title">
              ...
              <h3>
                BEEF-IT will offer you accountability for your fitness like never seen before. BEEF-IT provides you with
                all the information and techniques you need to accomplish your fitness goals.
              </h3>
        ...
        <section className="action-section">
          <div className="container">
            <div className="row">
              <div className="block-item" style={{ margin: '1%' }}>
                <div className="block-item-inner">
                  <h2>WORKOUT TRACKER</h2>
                  <h3>
                    Track your workouts and keep a record of all the workouts you have completed to view and reflect on
                  </h3>
                </div>
              </div>
              <div className="block-item" style={{ margin: '1%' }}>
                <div className="block-item-inner">
                  <h2>CREATE CUSTOMS</h2>
                  <h3>
                    Create your own custom workout plan for any type of fitness goal that you can publish and share with
                    others
                  </h3>
                </div>
              </div>
              <div className="block-item" style={{ margin: '1%' }}>
                <div className="block-item-inner">
                  <h2>FIND NEW EXERCISES</h2>
                  <h3>
                    Find new exercises that will help you achieve your fitness goal and learn the proper form for each
                    one
                  </h3>
                </div>
              </div>
